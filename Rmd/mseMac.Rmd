...
subtitle: "Example of MSE for Mackerel"
author: "L Kell"
...
```{r}
ggplot(FLQuants("ICES"=apply(stock.wt(mac[,"2021"]),1,mean),
                "OM"  =stock.wt(om[ ,"2080"]),
...
```{r}
ggplot(FLQuants("ICES"=m(mac[,"2021"]), 
                "OM"  =m(om[ ,"2080"]),
                "0.8" =m(om2[,"2080"]),
                "1.0" =m(om3[,"2080"]),
                "1.2" =m(om4[,"2080"])))+
...
```{r}
ggplot(FLQuants("ICES"=apply(mat(mac[,"2021"]),1,mean),
                "OM"  =mat(om[ ,"2080"]),
                "0.8" =mat(om2[,"2080"]),
                "1.0" =mat(om3[,"2080"]),
                "1.2" =mat(om4[,"2080"])))+
