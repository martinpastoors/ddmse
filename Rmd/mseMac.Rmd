...
opts_chunk$set(cache     =TRUE, 
               ...
               cache.path="../cache/mseMac/",
               fig.path  ="../tex/figs/mseMac/",
               fig.width =8,
               fig.height=6,
               dev       ="png")
...
```{r, pars}
par=FLPar(c(m1=0.15/(0.2^-0.288),m2=-0.288,bref=NA,b=0.3,matk=30.1,w50=0.2))
```
...
```{r,eq}
sr=fmle(as.FLSR(iter(stk,1),model="bevholt"),control=list(silent=TRUE))
...
```{r}
load("/home/laurie/Dropbox/pelagics/results/mac/figures/mac_objects.RData")
