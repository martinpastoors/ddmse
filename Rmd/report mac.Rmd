...
knitr::include_graphics(path=file.path(figuresdir, paste0(mystk,"_om_biomass_yield.jpg")))
...
**Comparison of equilibrium curves for density dependence analyses: biomass against F**
...
knitr::include_graphics(path=file.path(figuresdir, paste0(mystk,"_om_biomass_F.jpg")))
