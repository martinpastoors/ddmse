...
fig_nums(
  name    = "cond_mat", level = 2, display = FALSE,
...
fig_nums(
  name    = "cond_natmor", level = 2, display = FALSE,
...
fig_nums(
  name    = "cond_ddwaa", level = 2, display = FALSE,
...
fig_nums(
  name    = "cond_gammwaa", level = 2, display = FALSE,
...
tab_nums(
  name    = "cond_gammcoefficients", level = 2, display = FALSE,
...
fig_nums(
  name    = "cond_lmwaa", level = 2, display = FALSE,
...
tab_nums(
  name    = "cond_lmsummary", level = 2, display = FALSE,
...
fig_nums(
  name    = "cond_ddmat", level = 2, display = FALSE,
...
fig_nums(
  name    = "cond_matogive", level = 2, display = FALSE,
