...
Version 1.2 (17 March 2023; fixed error in figure 15)
...
fig_nums(
  ...
  caption = "F Kobe plot for 2050 for base case (no DD) for all $F_{MSY}$'s (red is from the right scenario). Topleft: base, topright: M, bottomleft: MM, bottomright: MMM")
