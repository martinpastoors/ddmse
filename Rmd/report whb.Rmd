...
The fixed maturity ogive for blue whiting was taken from the ICES assessment, this did not vary by year.
...
The variation in mass-at-age is shown in the figure below (left) and the relationship between mass-at-age and total biomass  to the right. Consistent negative slopes on the biomass-mass-at-age plots are seen for ages 4 and beyond. The patterns for the younger ages, however, are less clear. The younger ages do not appear strongly in the catches, and so the catches may not be representative of the population.
