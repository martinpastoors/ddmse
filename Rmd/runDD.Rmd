...
Mackerel life history parameters are used to construct an `FLBRP` object to represent the equilibrium dynamics and then an `FLStock` object models the time series dynamics.
