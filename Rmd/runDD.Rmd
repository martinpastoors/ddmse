...
This document provides an example of how to model density dependence in mass-at-age and M-at-age.
...
The Lorenzen relationship between mass-at-age and M is used to link M and weight-at-age. For example, lorenzen M = a*300^-0.288, so if you want M=0.2 at 300g then a= 0.2 /(300^-0.288)
...
**Figure `r iFig=iFig+1; iFig`** Density dependence multiplier
